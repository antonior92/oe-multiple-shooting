...
import numpy as np
from oeshoot.narx import (Linear, Polynomial, Monomial,
...
class TestSimulateDerivative(TestCase):
    ...
    def test_ar_model_derivatives(self):
        ...
        assert_array_almost_equal(jac_params, jac_params_numeric, decimal=2)
        assert_array_almost_equal(jac_y0, jac_y0_numeric, decimal=2)
